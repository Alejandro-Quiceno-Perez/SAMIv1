...
const passwordRegisterConfirmation = document.getElementById("passwordConfirmation");
...
async function createUser() {
    try {
        ...
        const userExist = await fetch(`${urlDesplegada}/users?email=${emailRegister.value}`)
...
async function validateLogin() {
    try {
        ...
        localStorage.setItem("userSami", data.email);
        console.log(data);
    } catch (error) {
        console.log(error.message);
    }
